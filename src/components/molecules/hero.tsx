    ...
    <main className="flex flex-col md:flex-row gap-8 flex-wrap justify-center mt-40 md:mt-50 px-5">
      <div className="max-w-3xl flex flex-col gap-6">
        ...
        >
          ...
          <p className="duration-300">n8n automation</p>
        </motion.div>
        <motion.h1
          initial={{ opacity: 0, translateY: "100%" }}
          whileInView={{ opacity: 1, translateY: 0 }}
        ...
        >
          Otomatiskan Alur Kerja Anda dengan Mudah
        </motion.h1>
        ...
        >
          Tingkatkan efisiensi bisnismu dengan automasi stok, notifikasi, dan
          laporan real-time — langsung dari Telegram.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, translateY: "100%" }}
          whileInView={{ opacity: 1, translateY: 0 }}
